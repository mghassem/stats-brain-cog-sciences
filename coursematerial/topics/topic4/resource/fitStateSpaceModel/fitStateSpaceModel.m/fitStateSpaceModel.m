...
function [p05, p95, pmid] = fitStateSpaceModel(Responses, MaxResponse, BackgroundProb);
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function to run the analysis of the individual subject learning curve using
...
% converted to script for portability by Anne Smith, 2017
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
% Output :
%
%        pmid        estimate of median probability of a correct response
% 
%        p05, p95    estimate of 90% confidence bounds
%
% function variables
